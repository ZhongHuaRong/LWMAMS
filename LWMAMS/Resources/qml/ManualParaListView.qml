...
CScrollView {
    ...
    Component.onCompleted: fileDialog.accepted.connect(paraView.fileUrls)
    ...
    function refreshFinsh(dirList){
        ...
        for(var a = 0;a<dirList.length;a++){
            ...
            //添加目录按钮
            object = button.createObject(row, {"width": 300,
                                                    "text":dirList[a]});
            object.clicked.connect(paraView.dirClicked);
            dirFile.push(object)

            //添加删除按钮
            object = button.createObject(row, {"width": 50,
                                                    "text":"移除"});
    ...
    Rectangle{
        ...
        TelescopicRectangle{
            ...
            anchors.topMargin: 0
            width: 400
            height:row.height+manualDir.headerHeidht+5
        ...
        TelescopicRectangle{
            ...
            anchors.topMargin: 0
            width: 400
            height:column.height + dirText.height + fileDir.headerHeidht + 10
